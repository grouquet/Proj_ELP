...
var $author$project$Main$getWordlist = $elm$http$Http$get(
	{
	...
	function (msg, model) {
		switch (msg.$) {
			case 'SendHttpRequest':
				return _Utils_Tuple2(model, $author$project$Main$getWordlist);
			case 'Submit':
			...
			case 'GotWords':
				if (msg.a.$ === 'Ok') {
					var content = msg.a.a;
					var wordList = $elm$core$String$words(content);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{wordList: wordList}),
			...
			case 'NewRandomNumber':
				var num = msg.a;
				var z = A2($author$project$Main$getRandomWord, num, model.wordList);
				if (z === '') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$ToggleAnswer)
					]),
				_List_fromArray(
					[
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$Main$init, $author$project$Main$getWordlist);
		},
